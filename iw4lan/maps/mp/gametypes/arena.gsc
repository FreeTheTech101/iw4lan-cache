...
main()
{
	...
	if ( getDvarInt( "g_hardcore" ) )
        ...
        game["dialog"]["offense_obj"] = "pushforward";
        game["dialog"]["defense_obj"] = "readytomove";
}
...
onStartGameType()
{
	...
	{
		setObjectiveScoreText( game["attackers"], &"OBJECTIVES_WAR_ATTACKER_SCORE" );
		setObjectiveScoreText( game["defenders"], &"OBJECTIVES_WAR_DEFENDER_SCORE" );
	}
